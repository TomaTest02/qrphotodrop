...
const PACKAGES = {
  ...
  botez: [
    ...
    { key: 'complet', name: 'Standard', price: 32900, subLabel: 'până în 150 invitați', popular: true, features: tierFeatures('complet') },
    { key: 'vis', name: 'Premium', price: 48900, subLabel: 'până în 300 invitați', features: tierFeatures('vis') },
  ],
  aniversare: [
    { key: 'intim', name: 'Basic', price: 24900, subLabel: 'până în 50 invitați', features: tierFeatures('intim') },
    { key: 'complet', name: 'Standard', price: 32900, subLabel: 'până în 150 invitați', popular: true, features: tierFeatures('complet') },
  ...
  corporate: [
    { key: 'intim', name: 'Basic', price: 32900, subLabel: 'până în 100 invitați', features: tierFeatures('intim') },
    { key: 'complet', name: 'Standard', price: 45900, subLabel: 'până în 300 invitați', popular: true, features: tierFeatures('complet') },
    { key: 'vis', name: 'Premium', price: 69900, subLabel: 'până în 600 invitați', features: tierFeatures('vis') },
  ],
};
const TABS = [
