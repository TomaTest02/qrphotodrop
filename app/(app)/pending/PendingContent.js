...
// Componentă pur vizuală. Starea (`suspended`) vine ca prop de la server component —
// fără useEffect + setState (ESLint: react-hooks/set-state-in-effect).
export default function PendingContent({ suspended = false }) {
  return (
