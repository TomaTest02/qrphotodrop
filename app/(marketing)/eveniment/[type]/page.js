      ...
      <section className={styles.accessSection}>
        <div className={styles.accessInner}>
          ...
          <div className={styles.accessGrid}>
            {[
              { icon: '📱', title: 'Cod QR digital', desc: 'Trimis pe WhatsApp sau afișat pe ecran.' },
              { icon: '🃏', title: 'Cartonașe fizice', desc: 'Printat pe cartonașe elegante pe masă.' },
              { icon: '🔗', title: 'Link direct', desc: 'Distribuit pe orice canal digital.' },
            ].map((item, i) => (
