...
export async function getAdminRoster(adminClient) {
  ...
  if (adminsError) throw new Error(`Nu s-a putut verifica lista administratorilor: ${adminsError.message}`);
  ...
  if (settingsError) throw new Error(`Nu s-au putut verifica rolurile administrative: ${settingsError.message}`);
