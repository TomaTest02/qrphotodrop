...
export async function sendArchiveReady(email, downloadUrl) {
  return getResend().emails.send({
    from: 'QRPhotoDrop <noreply@qrphotodrop.com>',
    to: email,
    ...
    html: `
      ...
      <a href="${downloadUrl}" style="background:#710927;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;">
        Descarcă Arhiva
      </a>
    `,
  });
